...
#define cl3DLIGHT		clWHITE
#define cl3DSHADOW      clBLACK
#define cl3DLIGHTDK     0xFF
#define cl3DSHADOWDK   	clBLACK
#define clTITLEACTIVE	clBLACK
#define clTITLEINACTIVE	clGREY
#define clTITLETEXT		clWHITE
#define clBTNTEXT		clBLACK
#define clBTNTEXTDOWN	clWHITE
#define clHIGHLIGHT		clBLACK
#define clKEYSEL		clBLACK
#define clKEYSHIFT		clSILVER
